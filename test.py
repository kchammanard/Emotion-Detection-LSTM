...
# DICT_EMO = {
#     0: 'Neutral',      # Neutral remains the same
#     1: 'Happiness',    # Happiness remains the same
#     2: 'Stressed',     # Sadness maps to Stressed
#     3: 'Surprise',     # Surprise remains the same
#     4: 'Stressed',     # Fear can be mapped to Stressed (or you can ignore it if preferred)
#     5: 'Stressed',     # Disgust maps to Stressed
#     6: 'Stressed'      # Anger maps to Stressed
# }
